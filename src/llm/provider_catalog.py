...
PROVIDER_CATALOG: dict[str, ProviderEntry] = {
    ...
    "kimi": {
        ...
        "models": [
            {"id": "kimi-k2.6",                "label": "Kimi K2.6 (latest, best)",          "tier": "heavy"},
            {"id": "kimi-k2.5",                "label": "Kimi K2.5 (balanced)",              "tier": "heavy"},
            {"id": "kimi-k2.5-thinking",       "label": "Kimi K2.5 Thinking (reasoning)",    "tier": "heavy"},
            {"id": "kimi-k2.5-thinking-turbo", "label": "Kimi K2.5 Thinking Turbo (faster)", "tier": "medium"},
            {"id": "kimi-k2-turbo-preview",    "label": "Kimi K2 Turbo (preview)",           "tier": "medium"},
            {"id": "kimi-k2-0905-preview",     "label": "Kimi K2 0905 (preview)",            "tier": "medium"},
            {"id": "kimi-k2-instruct",         "label": "Kimi K2 Instruct (legacy)",         "tier": "medium"},
            {"id": "kimi-latest",              "label": "Kimi Latest (auto-rolling)",        "tier": "heavy"},
        ...
        "supports": ["streaming", "web_search", "json", "thinking", "vision"],
        "custom_models_allowed": True,
    },
    "openai": {
        "label": "OpenAI",
